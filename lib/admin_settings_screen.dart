...
class AdminSettingsScreen extends StatelessWidget {
  ...
  const AdminSettingsScreen({super.key, required this.adminId, required this.username});
                        ...
                        children: [
                          ...
                          _buildSettingsSection("Account", [
                            _buildSettingsItem("Account & Security", () {
                              Navigator.push(context, MaterialPageRoute(builder: (c) => AccountSecurityScreen(
                                userId: adminId, 
                                username: username,
                                isAdmin: true,
                              )));
    ...
    return GestureDetector(
      onTap: () async {
        ...
        if (confirm == true) {
          ...
          await FirebaseDatabase.instance.ref().child("admins").child(adminId).child("devices").child(deviceId).remove();
